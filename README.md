...
```sh
npm install @tanstack/react-query@5.69.0 @tanstack/react-query-devtools@5.69.0 axios@1.8.4 dayjs@1.11.13 react-icons@5.5.0 react-router-dom@7.4.0 react-toastify@11.0.5 recharts@2.15.1 styled-components@6.1.16
...
```sh
npm install bcryptjs@3.0.2 concurrently@9.1.2 cookie-parser@1.4.7 dayjs@1.11.13 dotenv@16.4.7 express@5.1.0 express-async-errors@3.1.1 express-validator@7.2.1 http-status-codes@2.3.0 jsonwebtoken@9.0.2 mongoose@8.13.2 morgan@1.10.0 multer@1.4.5-lts.2 nanoid@5.1.5 nodemon@3.1.9 cloudinary@2.6.0 dayjs@1.11.13 datauri@4.1.0 helmet@8.1.0 express-rate-limit@7.5.0 express-mongo-sanitize@2.2.0
