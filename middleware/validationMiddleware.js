...
export const validateIdParam = withValidationError([
  param('id').custom(async (value, { req }) => {
    ...
    if (!isValidId) throw new BadRequestError('invalid MongoDB id'); //we can use js custom error class(Error) here instead BadRequestError.
    ...
    if (!isAdmin && !isOwner)
      throw new UnauthorizedError('not authorized to access this rout');
  }),
]);
